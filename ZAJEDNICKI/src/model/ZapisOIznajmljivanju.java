...
public class ZapisOIznajmljivanju implements ApstraktniDomenskiObjekat {
    ...
    public ZapisOIznajmljivanju(Date datumIznajmljivanja, double ukupanIznos, Bibliotekar bibliotekar, Citalac citalac,List<StavkaZapisaOIznajmljivanju> stavke) {
