...
public class StavkaZapisaOIznajmljivanju implements ApstraktniDomenskiObjekat {
    ...
    public StavkaZapisaOIznajmljivanju(int idZapis, int rb, int kolicina, double iznos, Date datumVracanja, Date maxDatumVracanja, boolean vracenoNaVreme, double cenaZaNepovracaj, Knjiga knjiga) {
        this.rb = rb;
    ...
    public String vratiVrednostiZaIzmenu() {
        return "rb=" + rb + ",idZapis=" + idZapis + ",datumVracanja='" + datumVracanja + "',maxDatumVracanja='" + maxDatumVracanja + "',kolicina=" + kolicina + ",iznos=" + iznos + ",cenaZaNepovracaj=" + cenaZaNepovracaj + ",vracenoNaVreme=" + vracenoNaVreme;    
    }
