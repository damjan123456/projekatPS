...
public class Komunikacija {
    ...
    public List<StavkaZapisaOIznajmljivanju> vratiStavke(StavkaZapisaOIznajmljivanju stavka) {
        List<StavkaZapisaOIznajmljivanju> stavke = new ArrayList<>();
        Zahtev zahtev = new Zahtev(Operacija.VRATI_STAVKE,stavka);
        posiljalac.posalji(zahtev);
        
        Odgovor odgovor = (Odgovor) primalac.primi();
        stavke = (List<StavkaZapisaOIznajmljivanju>) odgovor.getOdgovor();
        return stavke; 
    }
